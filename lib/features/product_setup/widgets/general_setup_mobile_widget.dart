...
class GeneralSetupMobileWidget extends StatelessWidget {
  const GeneralSetupMobileWidget({super.key});
      ...
      return Container(
        ...
        child: Container(
          ...
          child: Column(children: [
            ...
            CustomFieldWithTitleWidget(
              customTextField: CustomMenuTextFieldWidget(hintText: 'sku_hint'.tr,
                contentPadding: Dimensions.paddingSizeDefault,
                fontSize: Dimensions.fontSizeSmall,
